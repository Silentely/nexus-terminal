 ...
 * 处理获取所有路径历史记录的请求
 */
export const getAllPaths = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 * 处理根据 ID 删除路径历史记录的请求
 */
export const deletePath = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
 ...
 * 处理清空所有路径历史记录的请求
 */
export const clearAllPaths = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
