...
describe('Quick Command Tag Service', () => {
    ...
    describe('updateQuickCommandTag', () => {
        it('应成功更新标签', async () => {
            ...
            expect(QuickCommandTagRepository.updateQuickCommandTag).toHaveBeenCalledWith(1, 'UpdatedName');
        });
    ...
    describe('setCommandTags', () => {
        it('应成功设置指令的标签关联', async () => {
            ...
            expect(QuickCommandTagRepository.setCommandTagAssociations).toHaveBeenCalledWith(1, [1, 2, 3]);
        });
